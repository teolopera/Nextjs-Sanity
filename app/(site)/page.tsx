...
export default async function Home() {
  ...
  return (
    <div>
      <h1 className='text-7xl font-extrabold'>Hello I&apos;m <span className='dark:bg-gradient-to-r from-orange-400 via-red-500 to-purple-600 bg-clip-text dark:text-transparent'>Mateo!</span></h1>
